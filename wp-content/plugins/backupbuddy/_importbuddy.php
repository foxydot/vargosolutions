...
class pluginbuddy_importbuddy {
	...
	function __construct() {
		...
		if ( $this->_defaults['import_password'] == '#PASSWORD#' ) {
			...
			die( 'ERROR: Please verify that you downloaded this script from within BackupBuddy itself.  You cannot simply copy the importbuddy file from inside the plugin. The importbuddy.php script is generated and encoded upon download and your password is defined for security.' );
		} else {
...
function unpack_importbuddy() {
	if ( !is_writable( ABSPATH ) ) {
		...
		if ( false === strpos( file_get_contents( ABSPATH . 'importbuddy.php' ), '###PACKDATA,END' ) ) {
