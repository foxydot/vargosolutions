...
/*
   ...
   License: GPL2
*/
/*  Copyright 2012  Anze Stokelj  (email : wpplugins@lessthanweb.com)
...
if (version_compare($wp_version, '2.8', '>='))
{
	class ltw_tes_widget extends WP_Widget
	{
	    ...
	    function form($instance)
	    {
	        ...
	        $ltw_number_of_testimonials = isset($instance['ltw_number_of_testimonials']) == TRUE ? esc_attr($instance['ltw_number_of_testimonials']) : '';
	        $ltw_show_more_link = isset($instance['ltw_show_more_link']) == TRUE ? esc_attr($instance['ltw_show_more_link']) : '';
	        $ltw_show_more_text = isset($instance['ltw_show_more_text']) == TRUE ? esc_attr($instance['ltw_show_more_text']) : '';
	        $ltw_set_word_limit = isset($instance['ltw_set_word_limit']) == TRUE ? esc_attr($instance['ltw_set_word_limit']) : '';
	        $ltw_one_group_only = isset($instance['ltw_one_group_only']) == TRUE ? esc_attr($instance['ltw_one_group_only']) : '';
	        $ltw_show_picture = isset($instance['ltw_show_picture']) == TRUE ? esc_attr($instance['ltw_show_picture']) : '';
