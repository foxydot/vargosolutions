...
* Version 1.3.2 (2012/12/11)
	...
	* Fixed NOTICE bug where an empty variable was sent to $wpdb->prepare for no reason at all, was probably drunk when I added that (not that I drink)

* Version 1.3.1 (2012/05/24)
	* Fixed minor NOTICE bugs
	* 15 testimonials now shown on testimonials list page
	* Added the missing "count" field to the groups table
	* Fixed the "show in widget" checkbox not working
